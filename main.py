...
# وب‌سرور هلت‌چک برای زنده نگه داشتن ربات در رندر
...
async def global_message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if update.message.reply_to_message:
            try:
                ...
                if target_text and "User ID:" in target_text:
                    ...
                    await update.message.reply_text("✅ پیامت با موفقیت به دست مشتری رسید!")
                else:
    ...
    if context.user_data.get("support"):
        ...
        await update.message.reply_text("پیامت رو گرفتم عزیز دلم! 🌹 به ادمین منتقلش کردم.")
...
def main():
    ...
    # استفاده از ATTACHMENT به جای Document برای دور زدن باگ داخلی کتابخانه تلگرام
    app.add_handler(MessageHandler(filters.TEXT | filters.PHOTO | filters.ATTACHMENT, global_message_handler))
