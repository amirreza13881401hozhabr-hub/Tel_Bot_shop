...
def main():
    ...
    # راه اندازی وب‌سرور هلت‌چک در ترد جداگانه
    threading.Thread(target=run_health_server, daemon=True).start()
    print(f"Web Health Check Server started on port {PORT}")

    # استفاده از متد بومی run_polling که کاملاً با پایتون جدید سازگار است و نیازی به مدیریت دستی لوپ ندارد
    ...
    print("Telegram bot is starting with run_polling...")
